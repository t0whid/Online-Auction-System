...
echo"<div class='container'>";
				...
				echo"		<ul>";
					echo"		<li><a href='add_item.php' class='submit'>Sell Product</a></li>";
						echo"		<li><a href='displayfuture.php' class='submit'>Future Bids</a></li>";
								echo"		<li><a href='display_current.php' class='submit'>Ongoing Bids</a></li>";
	...
	echo "<b>*All bids having their end times already passed by current time<b>";
...
$statement = "SELECT * FROM item WHERE endtime < Now() ";
