...
/*prevents users from accessing the page directly*/
...
echo"<div class='container'>";
	...
	echo "<b>*All bids having their end times before midnight of the current day<b>";

echo"	</div>";
$username = $_SESSION["username"];


$statement = "SELECT * FROM item WHERE endtime between curdate() and curdate()+1 ";
